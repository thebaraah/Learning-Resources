...
The Codespace boots into the `data-track/` folder with Python 3.11 + the VS Code Python extensions provisioned via [`.devcontainer/devcontainer.json`](.devcontainer/devcontainer.json). Navigate to whichever week and exercise you're working on from the Explorer.
...
├── .devcontainer/          (Codespaces config: Python 3.11 + VS Code extensions)
│   └── devcontainer.json
├── week-1/
